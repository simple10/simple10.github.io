...
- **0.3.0 : 2013.02.24**
    - **Features**
    - Update theme bootstrap to 2.2.2. Add responsiveness and update design a bit.
...
- **0.2.8 : 2012.03.01**   
    ...
    - 0.2.7 : @daz Updates theme theme framework to use 2.x while still maintaining core layout. #50
